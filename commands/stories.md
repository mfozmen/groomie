...
to `<ISSUE-KEY>-groomed.md` (plus the `<ISSUE-KEY>-groomed.json` graph and a standalone interactive
`<ISSUE-KEY>-groomed.html`) and print the markdown. Do not write anything back to Jira.
