...
to `<ISSUE-KEY>/<ISSUE-KEY>-groomed.md` (plus the `<ISSUE-KEY>-groomed.json` graph and a standalone
interactive `<ISSUE-KEY>-groomed.html`, all under a per-issue folder named for the key) and print the
markdown. Do not write anything back to Jira.
